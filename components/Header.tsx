    ...
    <div className={menuOpen? 'popup-mobile-menu menu-open' : 'popup-mobile-menu' } >
        <div className="inner" >
            <div className="menu-top" >
                ...
                <p className="discription">Feel free to look around!
                </p>
            </div>
            <div className="content" >
                ...
                <div className="social-share-style-1 mt--40">
                    ...
                    <ul className="social-share d-flex liststyle">
                        ...
                        <li className="linkedin"><a href="https://www.linkedin.com/in/cyrus-tan-889b0a210/"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-linkedin">
